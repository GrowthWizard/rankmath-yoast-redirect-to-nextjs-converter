export default function UploadInfoBox({ CsvRows, CsvValues }) {
  return (
    <div className="px-5 max-w-7xl mx-auto pt-8 pb-16">
      ...
      <p className="font-montserrat mb-7 md:max-w-xl">The following table will help you, to check if your .csv upload was successfull. Please check your if the data in your .csv file matches with the data in the table.</p>
