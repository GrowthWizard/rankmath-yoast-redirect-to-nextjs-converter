export default function RedirectInfoBox({
  ...
  const OutputMesssageRedirects =
    "The following table will only show the 301 redirects we generated from your uploaded .csv file. Please note, that most SEO Plugins for WordPress will use 301 redirects, while next.js only supports 307 and 308 redirects. We will convert your 301 redirects into 308 redirects.";
