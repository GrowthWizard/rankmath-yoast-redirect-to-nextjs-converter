...
export default function howtouse() {
  return (
    <div>
      <Head>
        <title>
            How to convert Redirects from WordPress to next.js - wpToNext
        </title>
        <meta charSet="utf-8" />
      ...
      <div className="bg-dark">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center px-5 py-8 md:py-16 border-b border-white">
          <div className="mb-7 md:max-w-1/2 md:mb-0 md:pr-[5%]">
            ...
            This free tool was created for website owners who have decided to migrate their WordPress websites to next.js or to use next.js in conjunction with WordPress.  If you want to setup redirects in
              ...
              convert your WordPress redirects to next.js in seconds. If you'd like to learn more, check out the video below.
            </p>
          </div>
