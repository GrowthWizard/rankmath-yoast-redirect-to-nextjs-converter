  ...
  return (
    <article className="bg-dark">
      <main className="max-w-7xl mx-auto text-white py-7 px-5 md:py-16">
        ...
        <h4 className="font-source-sans text-2xl mb-7">
        ...
        <p className="font-montserrat mb-5">
          ...
          a complaint is in effect regardless of any other administrative or
        ...
        <p className="font-montserrat mb-5">
          ...
          with YouTube partners can be ruled out as a result of the expanded
          data protection mode. For instance, regardless of whether you are
          watching a video, YouTube will always establish a connection with the
        ...
        <p className="font-montserrat mb-5">
          ...
          result, the YouTube server will be notified, which of our pages you
        ...
        <p className="font-montserrat mb-5">
          ...
          YouTube will be able to obtain information about this website&rsquo;s
        ...
        <p className="font-montserrat mb-5">
          ...
          GDPR and &sect; 25 (1) TTDSG, insofar the consent includes the storage
          of cookies or the access to information in the user&rsquo;s end device
